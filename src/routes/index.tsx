...
import ClockingsList from '../components/Clocking/FindAll/ClockingsList';
...
import ExampleComponent from 'components/UserAccount/ExampleComponent';

  const AppRoutes = () => {
    return (
      <Router>
        <div style={{ display: 'flex', height: '100vh' }}>
          <div style={{ width: '280px', backgroundColor: '#f0f0f0', border: '2px solid black' }}> 
            <Menu /> 
          </div>
          <div style={{ flex: 1, padding: '20px', overflowY: 'auto' }}> 
            <Routes>
              ...
              <Route path='clockingsList' element={<ClockingsList />} />
